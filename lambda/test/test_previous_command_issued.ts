...
import r from './request/previous_command_issued.json'; 
...
describe('Audio Player Test : Previous Command Issued', function () {
  ...
  it('it responses with an NO audio directive ', () => {
